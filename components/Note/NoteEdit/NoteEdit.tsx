...
const NoteTitle = tw.input`w-full h-12 shrink-0 text-4xl font-bold text-[#343a3f] outline-none border-b-2 border-b-[#DDE1E6]`;
const NoteEditor = tw.div`h-full bg-blue-500`;
